...
golem::fill_desc(
  pkg_name = "whatRshiny", # The Name of the package containing the App 
  pkg_title = "A Jeapordy! Shiny App", # The Title of the package containing the App 
  pkg_description = "Play a round of Jeapordy! from a real game", # The Description of the package containing the App 
